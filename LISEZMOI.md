# Font Maker - Turbo Pascal - MS-Dos - 1991

[This page in English.](README.md)

Font Maker ou MkChar pour le nom physique de ce programme était un utilitaire pour dessiner des fontes de caractères pour des projets sous MS-Dos. Il a été développé sous [Turbo Pascal](https://fr.wikipedia.org/wiki/Turbo_Pascal) en 1991.
...
Vous trouverez l'exécutable (8 bits) dans le dossier "release". C'est la version du 19 septembre 1993. Vous ne pourrez l'exécuter que sur un émulateur MS-Dos, Windows 3.x ou 95. Inutile d'essayer sur Windows au delà de ces versions.
